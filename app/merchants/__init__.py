...
from app.merchants.views import MerchantsLoginResource, CodeLoginResource, ResetPasswordResource,PublishedNewsResource, \
    NewListResource, MapResource, RegisterResource, NewShowResource

api.add_resource(MapResource, '/')
api.add_resource(MerchantsLoginResource, '/passwd_login')
api.add_resource(CodeLoginResource, '/code_login')
api.add_resource(ResetPasswordResource, '/reset_passwor')
api.add_resource(PublishedNewsResource, '/published_news/<int:aid>')
api.add_resource(NewListResource, '/create_resource')
api.add_resource(RegisterResource, '/register')
api.add_resource(NewShowResource, '/newshow')




# #获取手机验证码
# @merchants.route('/test_code')
# def phone_code():
